...
namespace sdds {
	...
	MenuItem::~MenuItem(){
		if (this->content != nullptr) {
			cout << "dang xoa tu MENU ITEM: " << this->content << endl;
			delete[] this->content;
			this->content = nullptr;
			cout << "DA XOA TU MENU ITEM!" << endl;
		}
	...
	Menu::~Menu() {
		if(this->title!=nullptr){
			cout << "dang xoa tu MENU: TITLE: " << this->title << endl;
			delete[] this->title;
			this->title = nullptr;
			cout << "DA XOA TITLE" << endl;
		}
			
		for (int i = 0; i < this->menu_cnt; i++) {
			if (this->menuitems != nullptr) {
				cout << "dang xoa tu MENU: " << this->menuitems[i]->content << endl;
				delete this->menuitems[i];
				this->menuitems[i] = nullptr;
				cout << "DA XOA MENUITEM" << i << endl;
			}
		}
		cout << endl;
