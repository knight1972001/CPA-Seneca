...
{
    var folder = document.querySelector("#img");
    var image = "";

    for(var i = 0; i<images.length; i++)
    {
        image += '<figure><img src = "' + images[i].url + '" alt = "' + images[i].alt + '">';
        image += '<figcaption>' + images[i].caption + "</figcaption></figure>";
    }


    folder.innerHTML = image;
